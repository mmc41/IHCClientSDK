...
latest_update: 2026-08-30 — E18 US-088: the program's own failures are reported in the Problemer panel
---
...
| [18-problems-panel.md](18-problems-panel.md) | E18 a permanent panel listing the project's validation findings, kept current in the background, with double-click navigation to the offending element, and the program's own failures reported in the same place | US-080–086, US-088, validation findings, tier filters, sorting, navigation, transfer gate, findings export, internal faults | 290 |
...
| [18-problems-panel.md](18-problems-panel.md) | US-080–086, US-088 |
