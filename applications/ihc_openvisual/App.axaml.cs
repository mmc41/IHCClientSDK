...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            // ProjectSession for the whole window (US-063). The app is file-only: no controller is passed, so
            ...
            var session = new ProjectSession(projectService, backup, recent, dialogs, loggerFactory);
