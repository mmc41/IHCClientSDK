...
/// </summary>
public partial class EnumDefinitionWindow : Window
{
    private EnumDefinitionResult? _result;
    ...
    public static async Task<EnumDefinitionResult?> ShowAsync(Window owner, EnumDefinitionInput input)
    {
    ...
    private void OnOk(object? sender, RoutedEventArgs e)
    {
        List<string> states = (StatesBox.Text ?? string.Empty)
            ...
            .Where(s => s.Length > 0)
            .ToList();
        _result = new EnumDefinitionResult((TypeNameBox.Text ?? string.Empty).Trim(), states);
        Close();
    }
