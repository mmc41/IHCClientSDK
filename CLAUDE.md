...
- `tests/safe_project_tests/` - NUnit test suite for the `.vis` project engine and `ProjectAppService` (controller-free; byte-fidelity round-trips against `testdata/` oracles, editing, catalog, validation)
