...
public class NewProjectTemplateParityTests
{
    ...
    [Test]
    public void LocalitiesRoot_ShowsTheContainerNameStoredInTheProject()
    {
        // No shell: the claim is about what the PROJECTOR renders from a freshly created document, and a
        // harness here would only make a statement about one class look like one about the application.
        Project project = new ProjectAppService(new Ihc.IhcSettings())
