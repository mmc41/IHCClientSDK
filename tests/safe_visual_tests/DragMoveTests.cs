...
/// (the same <see cref="ProjectSession.MoveNodeAsync"/> op), with drop-target highlighting; an illegal target (the
...
/// via <see cref="ProjectSession.CanMoveNode"/> — not re-encoded in the view-model.
/// </summary>
