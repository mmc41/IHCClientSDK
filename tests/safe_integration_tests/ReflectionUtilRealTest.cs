...
{
    /// <summary>
    /// Unit tests for ReflectionUtil that verify it works correctly with real service instances.
    /// </summary>
    [TestFixture]
    public class ReflectionUtilRealTest
    {
        ...
        {
            // Arrange
            IAuthenticationService service = new AuthenticationService(Setup.settings!);
            string description = "Real AuthenticationService";
